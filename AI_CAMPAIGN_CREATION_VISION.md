...
- 🗂️ **ריבוי מקורות + Facts Merger** *(רעיון עתידי, לא מתוכנן, לא MVP)* — במקום לבחור מקור קלט אחד (החלטה 8), המשתמש "זורק" כמה **סוגי** מקורות שונים ביחד (אתר + PDF + תמונות + טקסט), כל אחד עם Extractor משלו, ומעל כולם שכבת **Facts Merger** שמאחדת ל-`ExtractedFacts` אחיד עם מעקב מקור לכל שדה (`{value, source}`) וטיפול בקונפליקטים בין מקורות. נדחה במפורש (2026-07-22): מפר את שני העקרונות ששני הספרינטים הראשונים הצליחו בזכותם — "ספרינט אחד = הנחה אחת" ו"לא בונים שכבה גנרית לפני שיש לה צורך מוכח". גם ה-Website Extractor השני עצמו טרם נבנה בפועל; אין עדיין שום עדות אמפירית שקונפליקטים בין מקורות הם בעיה אמיתית. לשקול מחדש רק אחרי שיש לפחות שני Extractors אמיתיים בשימוש.
