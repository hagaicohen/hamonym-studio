...
- שני Extractors בלבד ב-v1: **✍️ טקסט חופשי** (Sprint 1) ו-**🌐 אתר אינטרנט** (Sprint 4) — שניהם מומשו ומאומתים בקוד. Brief (Sprint 2) ו-Draft Mapping (Sprint 3) קדמו ל-Website Extractor בפועל.
